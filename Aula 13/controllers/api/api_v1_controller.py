...
def api_buscar_tmdb():
    termo = request.args.get("q", "") #TODO responda por que estamos utilizando o request.args.get?: o request.args.get("q, "") busca o parâmetro "q" da url, retornando vazio "" se ele não existir.
